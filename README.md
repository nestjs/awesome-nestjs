...
- ![](https://img.shields.io/github/stars/Softtor/nestjs-hexagonal.svg?style=flat-square) [`nestjs-hexagonal`](https://github.com/Softtor/nestjs-hexagonal) - Claude Code plugin for building NestJS bounded contexts with Hexagonal Architecture, DDD, and CQRS patterns.
