...
- ![](https://img.shields.io/github/stars/avifenesh/glidemq-nestjs.svg?style=flat-square) [`@glidemq/nestjs`](https://github.com/avifenesh/glidemq-nestjs) - High-performance message queue module powered by Valkey/Redis Streams with a Rust-native client. Decorators, DI, lifecycle management, and in-memory testing mode.
