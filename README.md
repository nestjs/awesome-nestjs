...
- [SaaS Starter](https://github.com/sayahweb2-png/saas-starter-lite) - Production-ready NestJS 11 + Angular 21 SaaS boilerplate with auth (JWT, OAuth, 2FA, magic links), Stripe subscriptions, multi-tenancy, RBAC, Docker, and Terraform for AWS.
